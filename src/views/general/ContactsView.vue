<template>
	<div class="bg-neutral-200 dark:bg-zinc-700 h-screen py-6 sm:py-8 lg:py-12">
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
			<div class="lg:text-center">
				<h2 class="text-base text-indigo-600 font-semibold tracking-wide uppercase">Контакти</h2>
				<p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-black dark:text-white sm:text-4xl">Ice Coffee</p>
				<p class="mt-4 max-w-2xl text-xl text-gray-800 dark:text-gray-200 lg:mx-auto">
					Ми працуємо тільки в межах міста Києва. Доставка відбувається в межах міста Києва.
				</p>
			</div>
			...
			<div class="mt-10">
				<dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
					...
					<div class="flex">
						...
						<div class="ml-4">
							<dt class="text-lg leading-6 font-medium text-indigo-500">Графік роботи</dt>
							<dd class="mt-2 text-base text-gray-800 dark:text-gray-200">
