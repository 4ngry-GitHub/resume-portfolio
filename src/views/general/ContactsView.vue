		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
			<div class="lg:flex lg:flex-wrap items-start -mx-4">
				...
				<div class="lg:w-1/2 px-4">
					 <img :src="defaultImage" alt="..." class="h-100 w-92 object-cover rounded-xl shadow-2xl dark:shadow-2xl">
				</div>
			</div>
		</div>
	</div>
...
<script>
import contactsPlaceholder from '@/assets/contacts-placeholder.jpg';

export default {
	name: 'ContactsView',
	data() {
		return {
			defaultImage: contactsPlaceholder,
		};
	},
	setup() {
		return { key: 'value' };
